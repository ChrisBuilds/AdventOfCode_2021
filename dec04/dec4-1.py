...
while not won and called_number_index < len(uncalled_numbers):
...
unmarked_numbers = [
    int(num) for num in winning_card.card_numbers if num not in called_numbers
]
print(sum(unmarked_numbers) * int(called_numbers[called_number_index - 1]))
print(winning_card)
